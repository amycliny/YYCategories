...
@property (nonatomic) CGPoint yy_center;      ///< Shortcut for center.
...
@property (nonatomic, getter=frameSize, setter=setFrameSize:) CGSize  yy_size; ///< Shortcut for frame.size.
